...
public class GameSystem {
    ...
    public GameSystem() {
        ArrayList<BaseMonkey> monkeyContainer = new ArrayList<BaseMonkey>();
        ArrayList<BaseMonkey> apeContainer = new ArrayList<BaseMonkey>();
        addApe();
    }
    ...
    public void addApe() {
        apeContainer.add(new Ape(200, 30, 10));
        apeContainer.add(new Ape(200, 30, 10));
        apeContainer.add(new Ape(200, 30, 10));
    }
    ...
    public void removeDeadEntity(ArrayList<BaseMonkey> entityContainer) {
        ...
        for(int i = 0; i < entityContainer.size(); i++){
            if(entityContainer.get(i).getHp() == 0){
                showDeadMessage(entityContainer.get(i), num);
                entityContainer.remove(entityContainer.get(i));
                i--;
            }
            num++;
        }
